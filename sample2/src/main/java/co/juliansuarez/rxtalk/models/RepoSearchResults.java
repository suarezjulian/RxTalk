...
public class RepoSearchResults {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof RepoSearchResults)) {
            return false;
        }
        RepoSearchResults rhs = ((RepoSearchResults) other);
        return new EqualsBuilder().append(totalCount, rhs.totalCount)
                .append(incompleteResults, rhs.incompleteResults).append(items, rhs.items).isEquals();
    }
